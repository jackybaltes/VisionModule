...
#if 0
int jpeg_utils::compress_yuyv_to_jpeg(FrameBuffer * src, unsigned char* buffer, int size, int quality)
{
...
int jpeg_utils::compress_fb_to_jpeg(FrameBuffer * src, unsigned char * buffer, int size, int quality)
{
    struct jpeg_compress_struct cinfo;
    struct jpeg_error_mgr jerr;
    JSAMPROW row_pointer[1];
    ...
    //    free (line_buffer); moved from calloc to alloca
